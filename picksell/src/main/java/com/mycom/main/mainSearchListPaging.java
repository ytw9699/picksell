...
public class mainSearchListPaging {
	...
	public mainSearchListPaging(int currentPage, int totalCount, int blockCount,
		...
		if (currentPage > blockPage) {
			if(!HowToSell.equals("3") || !order.equals("0") || !searchKeyword.equals("")) {
				pagingHtml.append("<a class='paging prv' href=" + MappingName + "?HowToSell="+HowToSell+"&order="+order+"&searchKeyword="+searchKeyword+"&p=" + (startPage - 1) + ">");
				pagingHtml.append("&lt;");
				pagingHtml.append("</a>");
			}else {
